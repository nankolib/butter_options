// Copy the Anchor IDL into the taker's own tree so `dist/` is self-contained on
// the VPS (no dependency on app/src/ being present at runtime). Runs as the
// postbuild step (see package.json "build"). OPTA_TAKER_IDL overrides the
