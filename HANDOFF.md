...
### Instruction inventory (35 production instructions on the main program as of 2026-06-12 — 29 Phase-2 + 4 Phase-1 exchange book + 2 Phase-2 Pass A series; the groups below are the post-Stage-A snapshot — the Phase 2 B–I additions + the exchange book + Pass A are listed at the end of this section)
...
- **35 production instructions** (Stage F added `exercise_american` + `migrate_shared_vault_exercise_tracking`; 2026-06-09 `reset_vol_oracle`; 2026-06-10 the 4 Phase-1 book instructions; 2026-06-12 the 2 Phase-2 Pass A series instructions). The `create_shared_vault` signature takes 7 args including `exercise_style: ExerciseStyle`.
