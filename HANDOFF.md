...
### Instruction inventory (37 production instructions on the main program as of 2026-06-12 — 29 Phase-2 + 4 Phase-1 exchange book + 2 Phase-2 Pass A series + 1 Phase-2 Pass B peg + 1 Phase-2 Pass C write merge; the groups below are the post-Stage-A snapshot — the Phase 2 B–I additions + the exchange book + Pass A + Pass B + Pass C are listed at the end of this section)
